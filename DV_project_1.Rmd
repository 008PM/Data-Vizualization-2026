...
ggplot(heatmap_df, aes(x = year, y = loc, fill = incidence)) +
  ...
  scale_fill_viridis_c(option = "magma", name = "Cases", na.value = "grey90") +
  scale_x_continuous(breaks = seq(1950, 1980, by = 5)) +
  labs(
    title = "Measles Cases by State and Year (1950–1980)",
    x = "Year",
...
# To save with more vertical space:
# ggsave("measles_heatmap.png", width = 12, height = 20, units = "in", dpi = 300)
