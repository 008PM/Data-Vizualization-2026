...
```
```{r}
# Beautiful bar chart of seasonal averages with 95% CI
ggplot(season_summary, aes(x = season, y = avg_cases)) +
  ...
  geom_col(aes(fill = season),
           width = 0.6,
           color = "white") +
  # Nice color palette for seasons
...
ggsave("measles_seasonal_bar.png", width = 10, height = 6, dpi = 300)
